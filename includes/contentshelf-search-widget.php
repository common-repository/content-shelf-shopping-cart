...
class ContentShelfSearchWidget extends WP_Widget {

    function __construct() {
        $widget_ops = array(
            'classname' => 'ContentShelfSearchWidget',
            'description' => __("Displays a simple search box for your customers to find a product in your store.",
                                'contentshelf-search-widget'),
        );
        parent::__construct('contentshelf_search', __('Content Shelf Search', 'contentshelf-search-widget'), $widget_ops);
    }
    ...
    function widget($args, $instance) {
        ...
        $widget_content = contentshelf_get_template('templates' . DIRECTORY_SEPARATOR . 'contentshelf-search-widget.php', compact('plugin_options', 'store_options'));
