...
class ContentShelfCartCountWidget extends WP_Widget {

    function __construct() {
        $widget_ops = array(
            'classname' => 'ContentShelfCartCountWidget',
            'description' => __("Displays a shopping cart count for your customers to see how many items are in their cart.",
                                'contentshelf-cart-count-widget'),
        );
        parent::__construct('contentshelf_cart_count', __('Content Shelf Cart Count', 'contentshelf-cart-count-widget'), $widget_ops);
    }
    ...
    function widget($args, $instance) {
        ...
        $widget_content = contentshelf_get_template('templates' . DIRECTORY_SEPARATOR . 'contentshelf-cart-count-widget.php', compact('plugin_options', 'store_options'));
